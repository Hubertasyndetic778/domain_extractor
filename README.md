...
## 🚀 Getting Started
Follow these simple steps to download and run **domain_extractor**.
...
Make sure you have Ruby installed on your computer. You can check this by opening your command line (Command Prompt on Windows or Terminal on macOS) and typing:
...
### 6. Run the Library
Navigate to the folder where you extracted **domain_extractor**. You can use the command line for this. For example:

```bash
cd path/to/domain_extractor
```
...
### 7. Use the Library
Once you run the script, follow the prompts to enter a URL. **domain_extractor** will parse the URL and display the domain components you need. 

## 🔧 Features
- **Multi-Part TLD Support:** Handles domains with multiple segments effectively.
- **Nested Subdomain Management:** Extracts subdomains without confusion.
- **Query Parameter Handling:** Supports URLs with various query parameters.
- **URL Normalization:** Cleans up URLs for consistent processing.
  
## 🖥️ System Requirements
- **Operating System:** Compatible with Windows, macOS, and Linux.
- **Ruby Version:** Requires Ruby 2.5 or newer.
- **RAM:** At least 512 MB for smooth performance.
- **Disk Space:** A minimum of 50 MB is sufficient for installation and operation.

## 🛠️ Troubleshooting
If you experience issues while using **domain_extractor**, consider the following steps:

- Ensure you have the latest version of Ruby installed.
- Verify that the public_suffix gem is correctly installed by running:

```bash
gem list
```

- Check for any typos in the command line when attempting to run the library.
